...
// Tambahkan Variants di import
import { motion, useInView, Variants } from "framer-motion"; 
import {Terminal,Send,CheckCircle2,XCircle,Loader2,MapPin,Mail,Clock,} from "lucide-react";
import { FaGithub, FaLinkedin, FaInstagram } from "react-icons/fa";

// ... (kode contactInfo dan socialLinks tetap sama)
...
const socialLinks = [
  { icon: <FaGithub size={18} />, href: "https://github.com/usernamekamu", label: "GitHub" },
  { icon: <FaLinkedin size={18} />, href: "https://linkedin.com/in/usernamekamu", label: "LinkedIn" },
  { icon: <FaInstagram size={18} />, href: "https://instagram.com/usernamekamu", label: "Instagram" },
];
...
export default function ContactMe() {
  ...
  const GOOGLE_SHEET_URL = "https://script.google.com/macros/s/AKfycbwVE3sqNzOuaWG4DKVfvbcb-0ceJMYkkinn3Wvo0JZtPttEPV7pNb-mjxVd_X2WaHut/exec";
  ...
  // PERBAIKAN DI SINI: Tambahkan tipe : Variants
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2 flex flex-col gap-6">
          <div className="rounded-xl border border-white/5 bg-white/[0.02] backdrop-blur-sm overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5 bg-black/20">
              ...
              <span className="ml-2 text-gray-600 font-mono text-xs">contact.sh</span>
            </div>
            <div className="p-5 font-mono text-sm space-y-4">
              <div className="text-gray-600">
                <span className="text-green-400">~</span>{" "}
                <span className="text-gray-400">cat contact_info.json</span>
              </div>
              ...
              <div className="space-y-3">
                {contactInfo.map((item, i) => (
                  ...
                  >
                    <span className="text-green-500/60">{item.icon}</span>
        ...
        <motion.div variants={itemVariants} className="lg:col-span-3">
          <div className="rounded-xl border border-white/5 bg-white/[0.02] backdrop-blur-sm overflow-hidden">
            <div className="flex items-center gap-2 px-6 py-4 border-b border-white/5 bg-black/20">
              ...
              <span className="text-gray-500 font-mono text-xs">send_message.tsx</span>
            </div>
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {[
                  { name: "name", label: "Nama", placeholder: "John Doe", type: "text" },
                  ...
                  <div key={field.name} className="flex flex-col gap-2">
                    <label className="font-mono text-xs text-gray-500 uppercase tracking-widest">
                      <span className="text-green-500">const</span> {field.label}
                    </label>
                    <div
              ...
              <div className="flex flex-col gap-2">
                <label className="font-mono text-xs text-gray-500 uppercase tracking-widest">
                  <span className="text-green-500">const</span> Pesan
                </label>
                <div
                  className={`relative rounded-lg border transition-all duration-300 ${
                    focused === "message"
